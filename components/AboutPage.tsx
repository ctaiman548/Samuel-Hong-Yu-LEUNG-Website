...
const BIO_TEXT = {
eng: [
    "Samuel Hong-yu LEUNG is a Hong Kong-born composer pursuing a Master&#8217;s degree in composition with Fabien Lévy and Mauro Lanza at the Conservatoire of Music and Theatre »Felix Mendelssohn Bartholdy« Leipzig, Germany. He graduated from the Chinese University of Hong Kong (CUHK) with a first-class honours Bachelor of Arts in Music. His recent orchestral work <i>...then, &#8220;he wrapped his face in his mantle&#8221;</i> is played by the MDR Leipzig Radio Symphony Orchestra. His work <i>Variations</i> for string quartet was selected to the International Society for Contemporary Music (ISCM) World New Music Days 2025 (Portugal) to represent the Hong Kong sector; another work <i>Excursion II</i> was also selected to represent Hong Kong at the 70<sup>th</sup> International Rostrum of Composers (Lithuania) and is nominated as one of the five recommended works in the under-30 category. Remarkably, his piano solo <i>Tastaturlust</i> has already been performed four times at different festivals, competitions, and concerts in Germany.",
    "Leung is frequently featured young composer on the Hong Kong music scene: he was commissioned to write for the season&#8217;s opening concert (2021-22) of the Hong Kong Chinese Orchestra, commissioned for the &#8220;2022 Hong Kong Contemporary Music Festival: Global Delights&#8221; organized by the Hong Kong Composers&#8217; Guild (HKCG), and invited to compose for &#8220;Transcending Music Legacy&#8221; to celebrate the 40<sup>th</sup> anniversary of HKCG (2023). He is also interested in participating in collaborative art projects. He joined &#8220;A Date with Dogs&#8221;, organized by the Leisure and Cultural Services Department (LCSD) &amp; Make A Difference Institute (MaD), which created interactive sound installations and music for dogs with public performances and garden tours. He was also participants of Darmstadt Summer Course 2025 and the Lucerne Academy for Contemporary Music 2026.",
    "Leung&#8217;s works have been performed by various music groups such as the MDR Leipzig Radio Symphony Orchestra, Dissolution Ensemble, Mivos Quartet, Metropolitana Soloist String Quartet, the Hong Kong Chinese Orchestra, and the Hong Kong New Music Ensemble (HKNME). He likes to explore musical form by arranging small, cell-like materials into quasi-improvisatory syntax that plays with the listener&#8217;s perception and anticipation."
  ],
  de: [
    "Samuel Hong-yu LEUNG ist ein in Hongkong geborener Komponist und Masterstudent in Komposition bei Fabien Lévy und Mauro Lanza an der University of Music and Theatre »Felix Mendelssohn Bartholdy« Leipzig. Er schloss sein Studium an der Chinese University of Hong Kong (CUHK) mit einem Bachelor of Arts in Musik mit First-Class Honours ab. Sein neuestes Orchesterwerk, <i>...then, &#8222;he wrapped his face in his mantle&#8220;</i>, wurde vom MDR-Sinfonieorchester aufgeführt. Sein Streichquartett <i>Variations</i> wurde für die International Society for Contemporary Music (ISCM) World New Music Days 2025 (Portugal) ausgewählt, um den Hongkong-Sektor zu repräsentieren, und erhielt den ISCM Young Composers Award; ein weiteres Werk, <i>Excursion II</i>, wurde ebenfalls ausgewählt, um Hong Kong beim 70<sup>th</sup> International Rostrum of Composers (Lithuania) zu vertreten, und ist als eines der fünf empfohlenen Werke in der Kategorie unter 30 nominiert. Bemerkenswerterweise wurde sein Klaviersolo <i>Tastaturlust</i> bereits viermal bei verschiedenen Festivals, Wettbewerben, und Konzerte in Deutschland aufgeführt.",
    ...
    "Leungs Werke wurden von verschiedenen Musikgruppen aufgeführt, darunter das MDR-Sinfonieorchester, Dissolution Ensemble, Mivos Quartet, das Metropolitana Soloist String Quartet, das Hong Kong Chinese Orchestra und das Hong Kong New Music Ensemble (HKNME). Er erkundet gerne musikalische Form, indem er kleine, zellartige Materialien zu einer quasi-improvisatorischen Syntax anordnet, die mit der Wahrnehmung und Erwartung des Hörers spielt."
  ],
  chin: [
    "梁康裕是香港作曲家，現於德國萊比錫音樂及戲劇學院跟隨 Fabien Lévy 和 Mauro Lanza 攻讀作曲碩士學位。他以一級榮譽成績畢業於香港中文大學音樂文學士課程。",
    "他的樂團作品《...then, “he wrapped his face in his mantle”》剛由德國中部電台交響樂團（MDR-Sinfonieorchester）演出。他的弦樂四重奏作品《Variations》曾獲選代表香港參加 2025 年在葡萄牙舉行的國際現代⾳樂協會（ISCM）世界⾳樂⽇，並榮獲 ISCM Young Composers Award；另一作品《Excursion II》亦獲選代表香港參加在立陶宛舉行的第 70 屆 International Rostrum of Composers，並被提名為 30 歲以下類別中五部推薦作品之一。值得一提的是，他的鋼琴獨奏作品《Tastaturlust》已在德國不同的音樂節、比賽及音樂會中四度演出。",
    "他的作品曾在香港重要音樂場合中發表，包括為香港中樂團 2021-22 樂季開季音樂會創作委約作品，為香港作曲家聯會主辦的「2022 香港現代音樂節：環宇薈萃」創作，以及受邀為慶祝 HKCG 成立四十週年的「傳承 ． 美樂之河」（2023）創作。他亦熱衷於參與跨界藝術合作項目，例如參與由康樂及文化事務署與 Make A Difference Institute（MaD）合辦的「A Date with Dogs」，為狗隻創作互動聲音裝置與音樂，並於多個公園中巡迴展出及舉辦公開演出。他亦活躍於各大現代音樂節，包括 Darmstadt 國際新音樂節 2025 與琉森現代音樂學院 2026。",
    "他的作品曾由多個音樂團體演出，包括德國中部電台交響樂團（MDR-Sinfonieorchester）、Dissolution Ensemble、Mivos Quartet、Metropolitana Soloist String Quartet、香港中樂團及香港創樂團等。他熱衷於排列細小的音樂素材，形成一種聽似即興式的語法並建構其音樂曲式（form），藉此「玩弄」聽者的感知與預想。"
  ]
};
