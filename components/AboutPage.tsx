...
const BIO_TEXT = {
  ...
  de: [
   "Samuel Hong-yu LEUNG ist ein in Hongkong geborener Komponist und Masterstudent in Komposition bei Fabien Lévy und Mauro Lanza an der University of Music and Theatre »Felix Mendelssohn Bartholdy« Leipzig. Er schloss sein Studium an der Chinese University of Hong Kong (CUHK) mit einem Bachelor of Arts in Musik mit First-Class Honours ab. Sein neuestes Orchesterwerk wird im Juli vom MDR-Sinfonieorchester aufgeführt. Sein Streichquartett <i>Variations</i> wurde für die International Society for Contemporary Music (ISCM) World New Music Days 2025 (Portugal) ausgewählt, um den Hongkong-Sektor zu repräsentieren, und erhielt den ISCM Young Composers Award; ein weiteres Werk, <i>Excursion II</i>, wurde ebenfalls ausgewählt, um Hong Kong beim 70<sup>th</sup> International Rostrum of Composers (Lithuania) zu vertreten, und ist als eines der fünf empfohlenen Werke in der Kategorie unter 30 nominiert. Bemerkenswerterweise wurde sein Klaviersolo <i>Tastaturlust</i> bereits dreimal bei verschiedenen Festivals und Wettbewerben in Deutschland aufgeführt.",
...
"Leungs Werke wurden von verschiedenen Musikgruppen aufgeführt, darunter das MDR-Sinfonieorchester, Dissolution Ensemble, Mivos Quartet, das Metropolitana Soloist String Quartet, das Hong Kong Chinese Orchestra und das Hong Kong New Music Ensemble (HKNME). Er erkundet gerne musikalische Form, indem er kleine, zellartige Materialien zu einer quasi-improvisatorischen Syntax anordnet, die mit der Wahrnehmung und Erwartung des Hörers spielt."
  ...
  chin: [
    ...
    "他的弦樂四重奏作品《Variations》曾獲選代表香港參加 2025 年在葡萄牙舉行的國際現代⾳樂協會（ISCM）世界⾳樂⽇，並榮獲 ISCM Young Composers Award；另一作品《Excursion II》亦獲選代表香港參加在立陶宛舉行的第 70 屆 International Rostrum of Composers，並被提名為 30 歲以下類別中五部推薦作品之一。值得一提的是，他的鋼琴獨奏作品《Tastaturlust》已在德國不同的音樂節與比賽中三度演出。",
    "他的作品曾在本地重要音樂場合中發表，包括為香港中樂團 2021-22 樂季開季音樂會創作委約作品，為香港作曲家聯會主辦的「2022 香港現代音樂節：環宇薈萃」創作，以及受邀為慶祝 HKCG 成立四十週年的「​傳承 ． 美樂之河」（2023）創作。他亦熱衷於參與跨界藝術合作項目，例如參與由康樂及文化事務署與 Make A Difference Institute（MaD）合辦的「A Date with Dogs」，為狗隻創作互動聲音裝置與音樂，並於多個公園中巡迴展出及舉辦公開演出。他亦活躍於各大現代音樂節，包括 Darmstadt 國際新音樂節 2025 與琉森現代音樂學院 2026。",
